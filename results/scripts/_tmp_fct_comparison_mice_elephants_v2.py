#!/usr/bin/env python3
"""Generate FCT comparison CSV and table PNG for mice_and_elephants."""
...
create_fct_comparison_table(
    ...
    out_csv,
    out_png,
    'FCT Comparison Table: HPCC vs HPCC+ | Mice and Elephants',
)
print('✓ Mice and Elephants FCT table completed')
