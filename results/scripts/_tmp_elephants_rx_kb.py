...
hpcc_rx   = base / 'results/study_cases/elephants_rx_buffer/case9_elephants_rx_buffer_HPPC/data/rxbuf_elephants_rx_buffer_HPPC.tr'
hpccp_rx  = base / 'results/study_cases/elephants_rx_buffer/case10_elephants_rx_buffer_HPPC_Plus/data/rxbuf_elephants_rx_buffer_HPPC_Plus.tr'
...
out_png   = base / 'results/study_cases/elephants_rx_buffer/plots_to_show/rx_buffer_comparison_1s_to_2s_HPCC_vs_HPCC_plus.png'
title     = 'RX Buffer Comparison (1.0s-2.0s): HPCC vs HPCC+ | Elephants RX Buffer'
