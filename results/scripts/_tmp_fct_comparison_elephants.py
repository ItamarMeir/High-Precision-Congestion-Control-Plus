#!/usr/bin/env python3
"""
Generate FCT comparison tables (CSV and PNG visualization) for elephants_rx_buffer case.
...
def create_fct_comparison_table(hpcc_fct_path, hpccp_fct_path, output_csv, output_png):
    ...
    ax.set_title('FCT Comparison: HPCC vs HPCC+ | Elephants RX Buffer', fontsize=12, fontweight='bold')
    ax.set_xticks(x)
...
create_fct_comparison_table(hpcc_fct, hpccp_fct, out_csv, out_png)
print("✓ Elephants RX Buffer FCT comparison completed")
