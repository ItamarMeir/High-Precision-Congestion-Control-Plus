...
NS3_EXECUTABLE_PATH = ['/workspace/simulation/build/src/emu', '/workspace/simulation/build/src/tap-bridge']
...
cfg_files = ['/workspace/simulation/build/ns3/config-store-config.h', '/workspace/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
