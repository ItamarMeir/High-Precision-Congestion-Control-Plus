...
{
  NS_LOG_FUNCTION (" New LC, rnti: "  << params.m_rnti);
...
{
  NS_LOG_FUNCTION (params.m_rnti << (uint32_t) params.m_logicalChannelIdentity);
...
{
  NS_LOG_FUNCTION (" Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf));
...
{
  NS_LOG_FUNCTION (" UL - Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf));
...
{
  NS_LOG_FUNCTION (" RNTI " << rnti << " txMode " << (uint16_t)txMode);
